...
const blog = () => {
  ...
  return (
    <><Header></Header>
      ...
      <div className="grid  items-center mx-20 text-justify">
        ...
        <p><b>1. What is an access token and refresh token?</b></p>
          ...
          <div className='flex justify-between gap-8'>
            ...
            <div> <p><b>* Access Token:</b><br></br></p>
              ...
              <br></br></div>
            <div>  <p><b>* Refresh Token:</b><br></br></p>
          ...
          <div className='flex justify-between gap-8'>
            ...
            <div className='w-1/2'> <p><b>* SQL Databases:</b><br></br></p>
             ...
             <br></br>
              <br></br></div>
            <div className='w-1/2'>  <p><b>* NoSQL Databases:</b><br></br></p>
          ...
          <p><b>1. What is Express JS and Nest JS ?</b></p>
          <div className='flex justify-between gap-8'>
            <div className='w-1/2'>
          ...
          <p><b>1. What is MongoDB aggregate and how does it work?</b></p>
          <div className='flex justify-between gap-8'>
            <div className='w-1/2'>
